...
figure <- pwm_support_plot + val_connecTF + val_connecTF_recall + mse_plot + 
...
figure <- n_edges+nTFs+nRegs + plot_layout(widths = c(1,1, 1)) + plot_annotation(tag_levels = 'a');figure
