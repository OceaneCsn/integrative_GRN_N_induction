...
ggexport(lost, filename = "results/supp_figures/wRF_example_gene_lost.pdf", width = 10, height = 5)
ggexport(saved, filename = "results/supp_figures/wRF_example_gene_saved.pdf", width = 10, height = 5)
...
## Comparing the ME of the two approaches
