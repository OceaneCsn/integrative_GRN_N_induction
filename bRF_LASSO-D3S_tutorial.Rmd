...
```{r}
pvalues <- LASSO.D3S_inference(counts, genes, tfs, alpha = 0.8, N = 100,
...
connecTF_validation <- evaluate_networks(list("bRF" = grn_bRF, "LASSO-D3S" = grn_lasso.d3s), 
                  input_genes = genes, input_tfs = tfs, nCores = 50); connecTF_validation
```

In this example, 44.5% of predicted edges by bRF and supported by ConnecTF, this is the case for 38.3% of the edges predicted by LASSO-D3S.
