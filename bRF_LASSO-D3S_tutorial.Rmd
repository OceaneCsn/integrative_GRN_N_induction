...
Let's infer a GRN using weightedRF with $\alpha=1$ and $D = 0.005$.
...
Let's infer a GRN using weightedLASSO with $\alpha=1$ and $D = 0.005$.
...
In agreement with the paper results, we encourage the use of gene-specific alphas, that can be determined by finding the values of alpha offering low prediction error as data integration increases, significantly more than on shuffled data.
