...
p <- draw_gene_effective_integration(gene_benefit, mats = mats, prior = 1) +
 ...
 test <- get_opt_alpha_per_gene(gene, mats = mats, lmses = lmses, dev = "true")
ggsave(test, file = "tmp.pdf")
...
n/o/p
figure <- n/o/p
ggexport(figure, filename = "results/supp_figures/gene_examples_weightedEN.pdf", width = 10, height = 9)
```
