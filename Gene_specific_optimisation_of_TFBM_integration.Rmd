...
save(alphas_lasso, file = "results/rdata/gene_specific/alpha_per_gene_weightedEN_true_sd.rdata")

# doing the same but with the value of alpha minimising the mse:
alphas_lasso <- mcsapply(genes, get_opt_alpha_per_gene, mats = mats, 
                         lmses = lmses, return_alpha=T, metric = "min", mc.cores=34)
save(alphas_lasso, file = "results/rdata/gene_specific/alpha_per_gene_weightedEN_min.rdata")
```
...
load(file = "results/rdata/gene_specific/gene_specific_grns_min.rdata")
...
for(rep in 1:nrep){ # exploring inherent variability
  ...
  mat_lasso <- weightedLASSO_inference(counts, genes, tfs,
                                   alpha = alphas_lasso, N = 25,
                                   tf_expression_permutation = FALSE,
                                   mda_type = "shuffle", EN_param = 0.1,
                                   pwm_occurrence = pwm_occurrence,
                                   nCores = nCores)
...
save(mats, file = "results/rdata/gene_specific/gene_specific_grns_min_en.rdata")
...
save(lmses, file = "results/rdata/gene_specific/gene_specific_mse_min_en.rdata") 
save(edges, file = "results/rdata/gene_specific/gene_specific_edges_min_en.rdata") 
...
save(val_specific, file = "results/rdata/gene_specific/gene_specific_validation_min_en.rdata")
```
