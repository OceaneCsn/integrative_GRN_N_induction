...
# Look at precision instead, in overexpression and target!
...
rbind.data.frame(precision_tga1_global_lasso, precision_tga1_global_rf) %>%
  ...
  ggplot(aes(x=alpha, y = value, fill = dataset)) + 
  facet_wrap(variable~model, ncol = 2) + geom_boxplot()+geom_point()+ggtitle("TGA1 precision on TARGET")
...
rbind.data.frame(precision_tga1_global_lasso, precision_tga1_global_rf) %>%
  ...
  ggplot(aes(x=alpha, y = value, fill = dataset)) + 
  facet_wrap(variable~model, ncol = 2) + geom_boxplot()+geom_point()+ggtitle("TGA4 precision on TARGET")
...
rbind.data.frame(precision_tga1_global_lasso, precision_tga1_global_rf) %>%
  ...
  ggplot(aes(x=alpha, y = value, fill = dataset)) + 
  facet_wrap(variable~model, ncol = 2) + geom_boxplot()+geom_point()+ggtitle("VRN1 precision on TARGET")
