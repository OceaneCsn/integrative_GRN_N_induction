...
for(alpha in alphas){
  ...
  importances_mLASSO_stars <- mLASSO_stars_inference(counts, genes, tfs, alpha = alpha, N = 5,
                                 pwm_occurrence = pwm_occurrence, nCores = 10)

  importances_wLASSO <- weightedLASSO_inference(counts, genes, tfs, alpha = alpha, N = 50,
                                 pwm_occurrence = pwm_occurrence, nCores = 10)
