...
ggexport(comps_en, filename = "results/comparisons_to_existing_methods/comparison_en.pdf", 
         width = 11, height = 8)
...
restricted_mse <- results %>%
  ...
  theme(strip.background = element_blank(),
        legend.position = "none");restricted_mse
...
final_comp <- plot_rf + comps_en + restricted_mse + plot_layout(heights = c(0.33, 0.33,1, 0.33))+plot_annotation(tag_levels = "a")
