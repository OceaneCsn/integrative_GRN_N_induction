...
save(val_conn, file = "results/100_permutations_lasso_validation.rdata")
...
save(val_chip, file = "results/100_permutations_lasso_validation_chip.rdata")
...
save(val_target, file = "results/100_permutations_lasso_validation_target.rdata")
...
```{r, fig.width=10}
load("results/100_permutations_lasso_edges_positive_same_density.rdata")
# number of edges per network
nrows <-
  data.frame(alpha_rep = names(unlist(lapply(edges, FUN = nrow))),
             n_edges = unlist(lapply(edges, FUN = nrow)))
...
save(val_conn_pos, file = "results/100_permutations_lasso_validation_cluster_pos.rdata")
...
val_chip[, settings] <-
  str_split_fixed(val_chip$network_name, '_', length(settings))
save(val_chip, file = "results/100_permutations_lasso_validation_chip_cluster_pos.rdata")
...
val_dap[, settings] <-
  str_split_fixed(val_dap$network_name, '_', length(settings))
save(val_dap, file = "results/100_permutations_lasso_validation_dap_cluster_pos.rdata")
...
load(file = "results/100_permutations_lasso_validation_cluster_pos.rdata")
...
load(file = "results/100_permutations_lasso_validation_dap_cluster_pos.rdata")
