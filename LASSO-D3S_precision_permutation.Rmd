...
save(edges, file = "results/100_permutations_lasso_edges_positive_same_density_mda0.rdata")
```
...
save(val_dap, file = "results/100_permutations_lasso_validation_dap_freq_gene_density.rdata")
